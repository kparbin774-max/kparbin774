    ...
    <div class="container">
        ...
        <div class="section">
            ...
            <form method="POST" action="/add_keys">
                <input type="text" name="product_code" placeholder="Product ID to link keys required" required>
...
def add_keys():
    ...
    if raw_keys:
        ...
        for k in key_list:
            clean_k = k.strip()
            if clean_k and not KeyStock.query.filter_by(license_key=clean_k, key_product_code=pcode).first():
