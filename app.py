...
# HTML Templates with Professional UI
LOGIN_PAGE = '''
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Admin Login - Shop Control Center</title>
    <style>
...
<head>
    ...
    <style>
        ...
        form input, form select { width: 100%; padding: 10px; margin-bottom: 15px; background: #0f172a; border: 1px solid #334155; border-radius: 6px; color: white; box-sizing: border-box; }
        form button { background: #10b981; color: white; border: none; padding: 10px 20px; border-radius: 6px; font-weight: bold; cursor: pointer; }
    ...
    <div class="container">
        ...
        <div class="section">
            ...
            <form method="POST" action="/add_keys">
                ...
                <textarea name="keys" rows="4" placeholder="Paste keys here (one key per line)" style="width:100%; padding:10px; background:#0f172a; border:1px solid #334155; border-radius:6px; color:white; margin-bottom:15px; box-sizing:border-box;" required></textarea>
...
def login():
    ...
    if request.method == 'POST':
        ...
        if password == 'admin123':  # अपना मनचाहा पासवर्ड यहाँ बदल सकते हैं
