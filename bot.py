...
# 1. अपना Telegram Bot Token यहाँ डालें
BOT_TOKEN = "YOUR_TELEGRAM_BOT_TOKEN_HERE"  # यहाँ अपना बॉट टोकन डालें

# 2. आपकी Render वाली लाइव वेबसाइट URL
...
def show_products(call):
    try:
        # वेबसाइट से लाइव प्रोडक्ट्स और स्टॉक मंगाना
        ...
        if response.status_code == 200:
            ...
            markup = types.InlineKeyboardMarkup(row_width=1)
            for p in products:
                btn_text = f"🚀 {p['name']} - ₹{p['price']} ({p['stock']} Available)"
            ...
            bot.send_message(call.message.chat.id, "❌ सर्वर से डेटा कनेक्ट नहीं हो पा रहा है।")
    except Exception as e:
        bot.send_message(call.message.chat.id, "❌ एरर: वेबसाइट से कनेक्शन नहीं हो पाया।")

@bot.callback_query_handler(func=lambda call: call.data.startswith("select_"))
def process_product_selection(call):
    product_id = call.data.split("select_")[1]
    
    # क्यूआर कोड (QR Code) जनरेट करना
    upi_id = "8292541899@ybl"  # आपकी Active UPI ID
    ...
    caption = f"📲 **Payment QR Code**\n\n<b>UPI ID:</b> <code>{upi_id}</code>\n\nक्यूआर कोड स्कैन करके पेमेंट करें और नीचे दिए गए 'I Have Paid' बटन पर क्लिक करें।"
...
def confirm_payment(call):
    ...
    # लाइव की (Key) वेबसाइट स्टॉक से निकालना
    try:
        ...
        if res.status_code == 200:
            ...
            if result.get('status') == 'success':
                ...
                bot.send_message(call.message.chat.id, "❌ स्टॉक खत्म हो गया है या की उपलब्ध नहीं है।")
        else:
